...
* *milanes_X_Y_lastname_Z.connlu* -- files with the annotated sentences (*X* and *Y* -- numbers of the first and last sentences, respectively; *Z* -- the total number of sentences annotated by <lastname>)
